function updated = PruneOnSpectralBalanceLess(params, filenameIn, filenameOut, targetsDir, wantTestMode)
% prune
...
plot(data.LFversusHFratio);

% if more HF than LF
goodIdx = find(data.LFversusHFratio(1:entriesData) < data.HFversusLFratio(1:entriesData) );
...
AllData.motorTargetMemory.HFversusLFratio = data.HFversusLFratio(goodIdx,:);
